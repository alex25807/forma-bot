...
async def choose_plan(cb: CallbackQuery):
    ...
    test_hint = (
        ...
        "<b>Важно:</b> списание реальное, если продолжить оплату.\n\n"
    ) if test_mode else ""
    ...
    await cb.message.answer(
        ...
        "💡 <b>Преимущества от использования бота</b>\n"
        "  ✅ Экономит время: меню и рецепты — уже готовы\n"
        "  ✅ Снимает «что поесть?»: меньше срывов и хаоса\n"
        "  ✅ Даёт структуру: ориентир КБЖУ + трекинг прогресса\n"
        "  ✅ Поддерживает каждый день: утро/вечер, без давления\n"
        "  ✅ Помогает держаться курса дешевле, чем\n"
        "     1 тренировка в зале или 2-3 доставки еды в месяц\n\n"
        "🎁 <b>Бонусы после подключения</b>\n"
        "  В рамках акций/челленджей FORMA\n"
        "  могут открываться временные тесты\n"
        "  отдельных расширенных функций.\n\n"
