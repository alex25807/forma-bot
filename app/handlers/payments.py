...
async def choose_plan(cb: CallbackQuery):
    ...
    await cb.message.answer(
        ...
        "💡 <b>Выгода FORMA</b>\n"
        "  По цене — доступный сегмент,\n"
        "  по возможностям — уровень верхних тарифов:\n"
        "  меню, рецепты, трекинг и фото-анализ.\n"
        "  Это примерно как 1 тренировка в зале\n"
        "  или 2-3 доставки еды в месяц.\n\n"
